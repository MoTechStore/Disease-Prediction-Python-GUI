...
l1 = ['back_pain', 'constipation', 'abdominal_pain', 'diarrhoea', 'mild_fever', 'yellow_urine',
      ...
      'yellow_crust_ooze','chills','headache','sweating','shivering']
...
root = Tk()
root.configure(background='#12343b')
root.title("Machine Learning Disease Prediction")
...
# Heading
w2 = Label(root, justify=CENTER,
           text="General Disease Prediction System", fg="#FFA500", bg="#12343b")
w2.config(font=("Verdana", 40))
w2.grid(row=1, column=0, columnspan=2, padx=100)

# labels
# we do not need to know the name of patient
#


S1Lb = Label(root, text="Symptom 1 ------------------------------------------------------------------------------------------>",
             fg="#FFA500", bg="#12343b", font="Verdana, 12 bold")
...
dst = Button(root, text="Predict Now",
             command=DecisionTree, bg="red", fg="white", font="Verdana, 12 bold")
dst.grid(row=12, column=1, padx=10)


lrLb = Label(root, text="There are chances that you may have:", bg="#12343b", fg="#FFA500", font="Verdana, 12 bold")
